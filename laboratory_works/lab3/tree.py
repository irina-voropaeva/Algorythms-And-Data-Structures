...
class LabTree:
    ...
    def __init__(self, pair=None, *children):
        ...
        if children is not None:
            for child in children:
                self.children.append(LabTree(child))
    ...
    def add(self, pair):
        ...
        if self.pair is None:
            self.pair = pair
        self.children.append(LabTree(pair))
...
class BTree:
    ...
    def __contains__(self, value):
        ...
        if self.pair[1] == value:
            return True
        elif (self.left is not None) and (value in self.left):
            return True
        elif (self.right is not None) and (value in self.right):
            return True
        return False
